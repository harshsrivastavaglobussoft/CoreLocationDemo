...
class GeotificationsViewController: UIViewController {
  ...
  func startMonitoring(geotification: Geotification) -> Void {
    ...
    if CLLocationManager.authorizationStatus() != .authorizedAlways {
      showAlert(withTitle: "Warning", message: "Your geotification is saved but will only be activated once you grant Geotify permission to access the device locaiton.")
    }
  ...
  func stopMonitoring(geotification: Geotification) -> Void {
